 ...
 */
export class LocizeAutomationPanel {
  public static currentPanel: LocizeAutomationPanel | undefined;
  ...
  public static render(extensionUri: Uri) {
    if (LocizeAutomationPanel.currentPanel) {
      ...
      LocizeAutomationPanel.currentPanel._panel.reveal(ViewColumn.One);
    } else {
